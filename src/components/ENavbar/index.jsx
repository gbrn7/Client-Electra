...
function ENavbar() {
  ...
  const [toggleState, setToggleState] = useState(localStorage.getItem('toggleState') 
  ...
  return (
      ...
      <div className="menu-bar h-100 d-flex justify-content-between flex-column">
        <div className="menu d-flex flex-column h-100 justify-content-between"> 
          ...
          <div className="bottom-content ">
            <ul>
            <NavLink iconClass={'bx bx-log-out'} action={handleLogout}>Logout</NavLink>
              <li className="mode">
    ...
    <div className="footer-wrapper fixed-bottom text-secondary d-none">
